            ...
            <div className="container">
                <div className="ship__top">
                    ...
                    <div className="ship__right">
                        ...
                        <div className='ship__main'>
                        <p className="ship__title">Курьерская доставка</p>
                        <p className='ship__desc'>Мы осуществляем доставку со склада по Москве и Московской области собственной курьерской службой. Транспортными компаниями нашу продукцию мы доставляем по всей территории РФ, а так же по всем странам СНГ. Сроки доставки: 4—6 недель</p>
                        </div>
                    </div>
                </div>
            </div>
